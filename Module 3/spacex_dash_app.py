...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        grouped_df = spacex_df.groupby('Launch Site')['class'].agg(['sum', 'count']).reset_index()
        grouped_df['success_rate'] = grouped_df['sum'] / grouped_df['count']
        fig = px.pie(grouped_df, values='success_rate', names='Launch Site',
